...
final readonly class Actor
{
    ...
    {
        return \Omp\Internal\actor_set_health($this->id, $health);
    }

    public function health(): float
    {
        return \Omp\Internal\actor_get_health($this->id);
    }

    public function setVirtualWorld(int $world): bool
    {
        return \Omp\Internal\actor_set_virtual_world($this->id, $world);
    }

    public function virtualWorld(): int
    {
        return \Omp\Internal\actor_get_virtual_world($this->id);
    }

    public function setPosition(Vector3 $position): bool
    {
        return \Omp\Internal\actor_set_pos($this->id, $position->x, $position->y, $position->z);
    }
    ...
    {
        return \Omp\Internal\actor_destroy($this->id);
    }
}
